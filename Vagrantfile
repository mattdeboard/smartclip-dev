...
Vagrant::Config.run do |config|
  ...
  config.vm.define :smartclip do |sc_config|
    ...
    sc_config.vm.forward_port 80, 8000 # apache
    ...
    sc_config.vm.share_folder "files", "/etc/puppet/files", "files"
    sc_config.vm.share_folder("smartclip", "/opt/smartclip",
                              "~/smartclip-dev/smartclip")
  end
end
